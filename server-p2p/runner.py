...
MELISSA_SERVER_MASTER_NODE = os.getenv("MELISSA_SERVER_MASTER_NODE")[6:].split(':')[0]
...
# runner algo:
    ...
    while True:
        ...
        job_id, parent_state_id = get_job(state_cache)  # job_id is the new job id the server will give me. we assume x contains also information on what time step we are on
