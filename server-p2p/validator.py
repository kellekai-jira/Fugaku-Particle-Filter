...
def validate(meta, compare_function, compare_reduction, evaluate_function,
    ...
    for state_id in state_ids:
        ...
        for p in cpc[1:]:
            ...
            print(f"df_rho_nominator: {df_rho_nominator['value']}, df_rho_denumerator_left: {df_rho_denumerator_left['value']}, df_rho_denumerator_right: {df_rho_denumerator_right['value']}")
